...
begin
  ...
  if Trim(sup_Lucro.Text) = ''
    then Begin
           Application.MessageBox('O campo de Lucro é obrigatório',
                                  'Informe o Lucro',
                                  MB_ICONERROR + MB_OK);
           sup_Lucro.SetFocus;
           Exit;
  ...
  if Trim(sup_Email.Text) = ''
   ...
   if Trim(sup_NomeResponsavel.Text) = ''
    then Begin
           Application.MessageBox('O campo de Nome do Responsável é obrigatório',
   ...
   if AnsiPos(' ',sup_TelefoneResponsavel.Text) <> 0
    then Begin
           Application.MessageBox('O telefone do responsável é inválido. Digite um telefone correto e tente novamente!',
                                  'Informe o telefone do responsável corretamente',
                                  MB_ICONERROR + MB_OK);
