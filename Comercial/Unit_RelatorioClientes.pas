...
begin
  ...
  if (StrToInt(label_CodInicio.Text) < StrToInt(label_CodFinal.Text)) then
    ...
    begin
      Application.MessageBox('Valor do primeiro campo maior que o segundo campo!', 'Atenção', MB_ICONINFORMATION+MB_OK);
      Exit;
    end;
  end
  else
    begin
      Application.MessageBox('Preencha o fitro do código para gerar o relatório', 'Atenção', MB_ICONINFORMATION+MB_OK);
      Exit;
    end;
end;
